...
module.exports = function (t) {
  t.test('Basic', (t) => {
    ...
    t.equal(wcm('pattern').separator, undefined)
    t.ok(wcm('pattern').regexp instanceof RegExp)
  })
  ...
  t.test('Accepts an array of patterns', (t) => {
    t.ok(wcm(['one'])('one'))
    t.notOk(wcm(['one'])('two'))
    t.ok(wcm(['**', 'one'])('whatever'))
    t.ok(wcm(['one', 'two', 'three'])('one'))
    t.ok(wcm(['one', 'two', 'three'])('two'))
    t.ok(wcm(['one', 'two', 'three'])('three'))
    t.notOk(wcm(['one', 'two', 'three'])('four'))
    t.ok(wcm(['one', 'one/two'], '/')('one'))
    t.ok(wcm(['one', 'one/two'], '/')('one/two'))
    t.notOk(wcm(['one', 'one/two'], '/')('two'))
    t.notOk(wcm(['one', 'one/two'], '/')('onetwo'))
    t.ok(wcm(['*', '*/*'], '/')('one'))
    t.ok(wcm(['*', '*/*'], '/')('two'))
    t.ok(wcm(['*', '*/*'], '/')('one/two'))
    t.notOk(wcm(['*', '*/*'], '/')('one/two/three'))
